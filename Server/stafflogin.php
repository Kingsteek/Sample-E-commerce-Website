<?php
  ...
  $formEmail = $_POST['sUser'];
  $formPassword = $_POST['sPassword'];
  ...
  $sql = "SELECT StaffID, Password FROM STAFF WHERE Email= '$formEmail' OR FirstName='$formEmail' OR LastName = '$formEmail'";  
